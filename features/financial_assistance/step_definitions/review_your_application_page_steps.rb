...
#
#   application.primary_applicant.incomes.create(title: "Income", amount: 40_000, kind: "wages_and_salaries", frequency_kind: "yearly", start_on: TimeKeeper.date_of_record - 1.year).save
