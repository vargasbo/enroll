...
And(/^they complete the form for the income$/) do
  fill_in 'income[amount]', with: '23.3'
  find_all(".interaction-choice-control-income-employer-address-state")[0].trigger('click')
  find_all(".interaction-choice-control-income-employer-address-state").select('Monthly')
  fill_in 'income[start_on]', with: "11/11/2016"
  fill_in 'income[end_on]', with: "11/11/2017"
