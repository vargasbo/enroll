...
RSpec.describe BenefitSponsors::Operations::BenefitApplication::FindModel, dbclean: :after_each do
  ...
  context 'sending required parameters' do
    ...
    it 'should find BenefitApplication instance' do
      expect(subject.call(params).success?).to be_truthy
      expect(subject.call(params).success).to be_a BenefitSponsors::BenefitApplications::BenefitApplication
    end

    it 'should return object' do
      expect(subject.call(params).success).to eq benefit_application
    end
  end
end
