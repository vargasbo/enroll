...
$(document).on('change', '#jq_datepicker_ignore_person_dob, #family_member_dob_, #jq_datepicker_ignore_organization_dob, #jq_datepicker_ignore_census_employee_dob, #census_members_plan_design_census_employee_dob, #dob, [name="jq_datepicker_ignore_dependent[dob]"]', function() {
